...
|------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software. |             Quispe, Fernando: TB1: Desarrollo de Diagrama de Clases, Artefactos de Needfinding. Guillén, Paolo: TB1: Desarrollo de la landing page de forma parcial, participación en el sprint para trabajar de forma más ágil el proyecto, así como haber participado en gran parte en la documentación del proyecto.     Cantoral, Diego: TB1: Desarrollo de la base de datos y Solution Profile    Llamo, Amner: TB1: Desarrollo de los diagramas de Arquitectura(C4), diseño de los wireframes y mock-ups de la aplicacion web.    Carrasco, Juan: TB1:              | TB1: Cómo equipo en esta entrega hemos participado en nuestro proyecto de manera eficiente, tal es el caso se puede demostrar una colaboración en nuestra organización de Github donde documentamos todos nuestros avances referentes a esta primera entrega. |
| Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software.                                                             | Quispe, Fernando: TB1: Elaboración de artefactos de Needfinding en base al conocimiento de los sectores.     Guillén, Paolo: TB1: Elaboración del diseño de la landing page con herramientas como Figma, despliegue de la landing page con herramienta de GithubPages, planteamiento parcial de la base de datos.    Cantoral, Diego: TB1: Planteamiento de la base de datos en base al funcionamiento de la startup   Llamo, Amner: TB1: Elaboracion de los ddiagramas de Arquitectura(C4) en base a nuestros segmentos objetivos.    Carrasco, Juan: TB1: | TB1: Cómo equipo conocemos claramente nuestros segmentos empresariales por una red de contactos, lo que nos permite empaparnos de los conocimientos de dichos sectores. Para obtener los requisitos para nuestro producto de Software.                        |
...
| 4      | US04    |Barra de navegación| Como visitante de la landing page. Quiero poder usar la barra de navegación de la landing page para desplazarme por esta.|3|
