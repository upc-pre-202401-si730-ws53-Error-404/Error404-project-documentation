...
| US17 | Integración con redes sociales | Como usuario, Quiero compartir fotos, consejos y logros de mi huerto con amigos o familiares en las redes sociales Para que vean mis logros con el cultivo. | **Escenario 1:** El usuario quiere compartir sus logros <br> Dado que el usuario finaliza un cultivo <br> Cuando selecciona la opción de compartir en redes <br> Entonces elige la red social y comparte su logro. | EPIC04: Comunidad y soporte |
